    ...
    <body>
        <body style="font-family: 'ＭＳ 明朝'">
            ...
            <h1 class="text-center">ログイン画面</h1>
                <p align="center">&nbsp;</p>
                <p align="center">ログインID　<input type="text" name="名前"></p>
                <p align="center">パスワード　<input type="text" name="名前"></p>
                    <p align="center">&nbsp;</p>
                <p align="center"><a align="center" class="btn btn-info btn-lg" href="user1lan.html" role="button">ログイン</a></p>
        </body>
        <!-- Optional JavaScript -->
